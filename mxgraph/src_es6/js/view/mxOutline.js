...
class mxOutline {
    ...
    update(revalidate) {
            ...
            this.outline != null && this.outline.container != null)
        {
            ...
            const unscaledGraphBounds = new mxRectangle(scaledGraphBounds.x / sourceScale + this.source.panDx,
                    scaledGraphBounds.y / sourceScale + this.source.panDy, scaledGraphBounds.width / sourceScale,
                    scaledGraphBounds.height / sourceScale);

            const unscaledFinderBounds = new mxRectangle(0, 0,
            ...
            if (scale > 0)
            {
                ...
                const b2 = new mxRectangle(this.bounds.x + this.bounds.width - b.width / 2,
    ...
    mouseDown(sender, me) {
        if (this.enabled && this.showViewport)
        {
            ...
            const hit = (this.source.allowHandleBoundsCheck && (mxClient.IS_IE || tol > 0)) ?
