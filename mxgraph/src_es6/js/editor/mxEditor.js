...
class mxEditor extends mxEventSource {
    ...
    addActions() {
        ...
        this.addAction('zoom', editor => {
            ...
            const scale = parseFloat(mxUtils.prompt(
    ...
    createDiagramLayout() {
        ...
        const layout = new mxStackLayout(this.graph, !this.horizontalFlow,
     ...
     */
    groupCells() {
        const border = (this.groupBorderSize != null) ?
    ...
    showHelp(tasks) {
        if (this.help == null)
        {
            ...
            const wnd = new mxWindow(mxResources.get(this.helpResource) || this.helpResource,
